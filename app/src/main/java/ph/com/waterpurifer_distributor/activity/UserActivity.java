...
public class UserActivity extends BaseActivity {
    ...
    ImageView ivUserName1;
    @BindView(R.id.view_repir_1)
    View viewRepir1;
    ...
    @BindView(R.id.view_repir_3)
    View viewRepir3;
    @BindView(R.id.rl_user_cpass)
    RelativeLayout rlUserCpass;
    ...
    public void doBusiness(Context mContext) {
        tvPhone.setText(getSellerPhone());
    }
