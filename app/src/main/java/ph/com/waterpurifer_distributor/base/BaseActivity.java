...
//     public abstract void setActivityPre();
    ...
    public int getSellerId() {
        SharedPreferencesHelper sharedPreferencesHelper=new SharedPreferencesHelper(this,"my");
        int sellerId= (int) sharedPreferencesHelper.getSharedPreference("sellerId",0);
        return sellerId ;
    }

    public int getSellerRole() {
        SharedPreferencesHelper sharedPreferencesHelper=new SharedPreferencesHelper(this,"my");
        int sellerRole= (int) sharedPreferencesHelper.getSharedPreference("sellerRole",0);
        return sellerRole ;
    }

    public String getSellerCoName() {
        SharedPreferencesHelper sharedPreferencesHelper=new SharedPreferencesHelper(this,"my");
    ...
    public String getSellerPassword() {
        SharedPreferencesHelper sharedPreferencesHelper=new SharedPreferencesHelper(this,"my");
        String sellerPassword= (String) sharedPreferencesHelper.getSharedPreference("sellerPassword","0");
        return sellerPassword ;
    }

    public String getSellerManagePassword() {
        SharedPreferencesHelper sharedPreferencesHelper=new SharedPreferencesHelper(this,"my");
        String sellerManagePassword= (String) sharedPreferencesHelper.getSharedPreference("sellerManagePassword","0");
        return sellerManagePassword ;
    }

    public String getSellerName() {
        SharedPreferencesHelper sharedPreferencesHelper=new SharedPreferencesHelper(this,"my");
        String sellerName= (String) sharedPreferencesHelper.getSharedPreference("sellerName","0");
        return sellerName ;
    }
